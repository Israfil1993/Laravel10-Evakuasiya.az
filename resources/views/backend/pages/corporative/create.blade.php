...
@section('title', 'Admin | Create Corporativ')
...
@section('content')
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('admin.corporative.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="tab-content p-3 text-muted">
                        <div class="tab-pane active" id="az" role="tabpanel">
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="card-title">Korporativ Əlavə Et (Az)</h4>
                                            <div class="row mb-3">
                        ...
                        <div class="tab-pane" id="en" role="tabpanel">
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="card-title">Korporativ Create (En)</h4>
                                            <div class="row mb-3">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                <a href="{{ route('admin.corporative.list') }}" class="btn btn-danger">Geri</a>
                            </div>
                        </div>
