        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('admin.about.update', $about->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="previous_image" value="{{ $about->image }}">
                        ...
                        <div class="tab-pane active" id="az" role="tabpanel">
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="card-title">Haqqımızda Düzənlə (Az)</h4>
                                            <div class="row mb-3">
                                                <label for="title_az" class="col-sm-2 col-form-label">Başlıq (Az)</label>
                                                <div class="col-sm-10">
                                            ...
                                            <div class="row mb-3">
                                                <label for="editor_az" class="col-sm-2 col-form-label">Təsvir (Az)</label>
                                                <div class="col-sm-10">
                                                    <textarea class="form-control"
                                                              name="description_az"
                                                              id="editor_az"
                                                              cols="30"
                                                              rows="10">{{ $about->description_az }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="tab-pane" id="en" role="tabpanel">
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="card-title">About Edit (En)</h4>
                                            <div class="row mb-3">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <textarea class="form-control"
                                                              ...
                                                              id="editor_en"
                                                              cols="30"
                                                              rows="10">{{ $about->description_en }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="tab-pane" id="ru" role="tabpanel">
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="card-title">О редактировании (Ru)</h4>
                                            <div class="row mb-3">
                                                <label for="title_ru" class="col-sm-2 col-form-label">Заголовок (Ru)</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control"
                                                           type="text"
                                                           name="title_ru"
                                            ...
                                            <div class="row mb-3">
                                                <label for="editor_ru" class="col-sm-2 col-form-label">Описание (Ru)</label>
                                                <div class="col-sm-10">
                                                    <textarea class="form-control"
                                                              name="description_ru"
                                                              id="editor_ru"
                                                              cols="30"
                                                              rows="10">{{ $about->description_ru }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select class="form-select" aria-label="Default select example " name="status">
                                    <option value="0" {{ $about->status == 0 ? 'selected' : '' }}>No Aktiv</option>
                                    <option value="1" {{ $about->status == 1 ? 'selected' : '' }}>Aktiv</option>
                                </select>
                                @error('status')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
