...
@section('title', 'Admin | Xəbərlər Edit')
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.post.update', $post->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="previous_image" value="{{ $post->image }}">

                        <h4 class="card-title">Xəbərlər Edit</h4>
                        ...
                        <div class="tab-content p-3 text-muted">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control"
                                                  ...
                                                  id="editor_az"
                                                  cols="30"
                                                  rows="10">{{ $post->description_az }}</textarea>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control"
                                                  ...
                                                  id="editor_en"
                                                  cols="30"
                                                  rows="10">{{ $post->description_en }}</textarea>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control"
                                                  ...
                                                  id="editor_ru"
                                                  cols="30"
                                                  rows="10">{{ $post->description_ru }}</textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <img class="rounded avatar-lg"
                                         src="{{ (!empty($post->image)) ? url('uploads/posts/'.$post->image) : url('uploads/default.jpg') }}"
                                         alt=""
                                         id="imageShow">
                                </div>
                            </div>
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <a href="{{ route('admin.post.list') }}" class="btn btn-danger">Geri</a>
                                </div>
                            </div>
